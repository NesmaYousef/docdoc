...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _InitialSignup<T> value)?  initialSignup,TResult Function( SignupLoading<T> value)?  signupLoading,TResult Function( SignupSuccess<T> value)?  signupSuccess,TResult Function( SignupError<T> value)?  signupError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _InitialSignup() when initialSignup != null:
return initialSignup(_that);case SignupLoading() when signupLoading != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _InitialSignup<T> value)  initialSignup,required TResult Function( SignupLoading<T> value)  signupLoading,required TResult Function( SignupSuccess<T> value)  signupSuccess,required TResult Function( SignupError<T> value)  signupError,}){
final _that = this;
switch (_that) {
case _InitialSignup():
return initialSignup(_that);case SignupLoading():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _InitialSignup<T> value)?  initialSignup,TResult? Function( SignupLoading<T> value)?  signupLoading,TResult? Function( SignupSuccess<T> value)?  signupSuccess,TResult? Function( SignupError<T> value)?  signupError,}){
final _that = this;
switch (_that) {
case _InitialSignup() when initialSignup != null:
return initialSignup(_that);case SignupLoading() when signupLoading != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initialSignup,TResult Function()?  signupLoading,TResult Function( T data)?  signupSuccess,TResult Function( ApiErrorModel apiErrorModel)?  signupError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InitialSignup() when initialSignup != null:
return initialSignup();case SignupLoading() when signupLoading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initialSignup,required TResult Function()  signupLoading,required TResult Function( T data)  signupSuccess,required TResult Function( ApiErrorModel apiErrorModel)  signupError,}) {final _that = this;
switch (_that) {
case _InitialSignup():
return initialSignup();case SignupLoading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initialSignup,TResult? Function()?  signupLoading,TResult? Function( T data)?  signupSuccess,TResult? Function( ApiErrorModel apiErrorModel)?  signupError,}) {final _that = this;
switch (_that) {
case _InitialSignup() when initialSignup != null:
return initialSignup();case SignupLoading() when signupLoading != null:
return signupLoading();case SignupSuccess() when signupSuccess != null:
...
class _InitialSignup<T> implements SignupState<T> {
  const _InitialSignup();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _InitialSignup<T>);
}
...
@override
String toString() {
  return 'SignupState<$T>.initialSignup()';
}
