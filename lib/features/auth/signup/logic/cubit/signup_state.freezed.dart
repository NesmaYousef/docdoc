...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _InitialSignup<T> value)?  signupInitial,TResult Function( SignupLoading<T> value)?  signupLoading,TResult Function( SignupSuccess<T> value)?  signupSuccess,TResult Function( SignupError<T> value)?  signupError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _InitialSignup() when signupInitial != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _InitialSignup<T> value)  signupInitial,required TResult Function( SignupLoading<T> value)  signupLoading,required TResult Function( SignupSuccess<T> value)  signupSuccess,required TResult Function( SignupError<T> value)  signupError,}){
final _that = this;
switch (_that) {
case _InitialSignup():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _InitialSignup<T> value)?  signupInitial,TResult? Function( SignupLoading<T> value)?  signupLoading,TResult? Function( SignupSuccess<T> value)?  signupSuccess,TResult? Function( SignupError<T> value)?  signupError,}){
final _that = this;
switch (_that) {
case _InitialSignup() when signupInitial != null:
return signupInitial(_that);case SignupLoading() when signupLoading != null:
